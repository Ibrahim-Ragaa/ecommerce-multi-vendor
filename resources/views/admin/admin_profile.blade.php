                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ $data->photo }}" alt="Admin" class="rounded-circle p-1 bg-primary"
                                        width="110">
                                    <div class="mt-3">
                                        <h4>{{ $data->username }}</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="photo" class="form-control" type="file" id="edit-image">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img class="rounded-circle avatar-xl"
                                            src="{{ !empty($data->photo) ? url('upload/admin_image/' . $data->photo) : url('upload/no.webp') }}"
                                            alt="Card image cap" id="show-image" style="width: 100px; height:100px">
                                    </div>
                                </div>
                                <div class="row">
