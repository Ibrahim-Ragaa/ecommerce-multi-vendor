                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('mecom-backend/assets/images/icons/chair.png') }}"
                                                alt="">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('mecom-backend/assets/images/icons/shoes.png') }}"
                                                alt="">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('mecom-backend/assets/images/icons/headphones.png') }}"
                                                alt="">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('mecom-backend/assets/images/icons/idea.png') }}"
                                                alt="">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('mecom-backend/assets/images/icons/user-interface.png') }}"
                                                alt="">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('mecom-backend/assets/images/icons/watch.png') }}"
                                                alt="">
                                        </div>
                                        <div class="ms-2">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ asset('mecom-backend/assets/images/icons/tshirt.png') }}"
                                                alt="">
                                        </div>
                                        <div class="ms-2">
